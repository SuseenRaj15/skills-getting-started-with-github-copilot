...
activities = {
    ...
    "Swimming Club": {
        "description": "Lap swimming, stroke development, and swim meets",
    ...
    "Choir": {
        "description": "Vocal training and choral performances throughout the year",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 40,
        "participants": ["mia@mergington.edu", "charlotte@mergington.edu"]
    },
    "Debate Team": {
        "description": "Preparation for interschool debates, public speaking and research",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["eli@mergington.edu"]
    },
    "Science Club": {
